...
class TestDatabricksUtils(unittest.TestCase):
    ...
    def test_get_databricks_configs(self):
        ...
        stanza_return_value = {"databricks_instance" : "123", "databricks_personal_access_token" : "pat123"}
    ...
    def test_get_clear_token_pat(self, mock_manager):
        db_utils = import_module('databricks_common_utils')
        mock_manager.return_value.get_password.return_value = json.dumps({"databricks_personal_access_token":"PAT token"})
