...
- Use Splunk SQL database extension to integrate Databrics information with Splunk queries and reports (Fig 4 & Fig 5)
...
<br/><br/>
#### Fig 4: 
Use Splunk SQL database extension to integrate Databrics information with Splunk queries and reports <br/><img src="/docs/markdown/images/dbconnect1.png" height="70%" width="70%"><br/>
